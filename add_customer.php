            ...
            <div class="card card-body">
              ...
              <form class="form-horizontal">
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="customerNotes" name="customerNotes" rows="5"></textarea>
                </div>
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" id="customerBusinessName" name="customerBusinessName" class="form-control"  />
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="secondaryContactName" name="secondaryContactName" class="form-control"  />
                    </div>
                  </div>
                  
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">SecondaryContactPhone</label>
                      <input type="text" id="secondaryContactPhone" name="secondaryContactPhone" class="form-control"  />
                    </div>
                  </div>
                </div>

                <div class="mb-3">
                  <label class="form-label">APContactName</label>
                  <input type="text" id="aPContactName" name="aPContactName" class="form-control"  />
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="aPContactEmail" name="aPContactEmail" class="form-control"  />
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="aPContactPhone" name="aPContactPhone" class="form-control"  />
                    </div>
                  </div>
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="isOnline" name="isOnline" id="inlineFormCustomSelect">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="date" id="lastOrderDate" name="lastOrderDate" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-3">
                      <label class="form-label">Last Quote Date</label>
                      <input type="date" id="lastQuoteDate" name="lastQuoteDate" class="form-control"  />
                    </div>
                  </div>
                </div>
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="date" id="taxExemptNumber" name="taxExemptNumber" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-3">
                      <label class="form-label">CallStatus</label>
                      <select class="form-select" id="callStatus" name="callStatus" id="inlineFormCustomSelect">
                        <option selected>Choose...</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
