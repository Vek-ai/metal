        ...
        <div class="container-fluid">
          <div class="col-12">
            ...
            <div class="card card-body">
              <h4 class="card-title">Add Warehouse Details</h4>
              ...
              <form class="form-horizontal">
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">WarehouseCapacity</label>
                      <input type="text" id="warehouseCapacity" name="warehouseCapacity" class="form-control"  />
                    </div>
                  </div>
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="rows" name="rows" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="binCapacity" name="binCapacity" class="form-control"  />
                    </div>
                  </div>
                </div>
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">CountDate</label>
                      <input type="date" id="countDate" name="countDate" class="form-control"  />
                    </div>
                  </div>
                </div>
                ...
                <div class="row pt-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="date" id="contactEmail" name="contactEmail" class="form-control"  />
                    </div>
                  </div>
                </div>
            ...
            <div >
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive" style="overflow-y:hidden; h-100">
                    <table id="display_category" class="table table-striped table-bordered text-nowrap align-middle" >
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>Inventory count completed</td>
                        </tr>
                        <tr>
                            <td>Eastside Warehouse</td>
                            <td>Boston, MA</td>
                            <td>15</td>
                            <td>8</td>
                            <td>30</td>
                            ...
                            <td>Ongoing renovations</td>
                        </tr>
                        <tr>
                            <td>Westside Warehouse</td>
                            ...
                            <td>Scheduled for next month</td>
                        </tr>
                    </tbody>
