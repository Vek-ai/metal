            ...
            <div class="card card-body">
              ...
              <form class="form-horizontal">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" id="secondaryName" name="secondaryName" class="form-control"  />
                </div>
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="secondaryPhone" name="secondaryPhone" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="row pt-3">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" id="freightRate" name="freightRate" class="form-control"  />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
